...
const name = path.basename(pathFile) || "swagger.json"
...
const cmd = `openapi-generator-cli generate --input-spec ${tempFile} --generator-name dart-dio --output ./temp11 --config api.json`
